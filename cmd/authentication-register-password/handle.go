...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.RegisterPasswordRequest
	...
	resp, err := dal.RegisterPassword(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully LoginRefreshToken for entity: "+req.PrimaryEmail+" for caller: "+caller)
}
