...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.GetEntityDetailsRequest
	...
	resp, err := dal.GetEntityDetails(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully GetEntityDetails for entity: "+req.Entity.String()+" for caller: "+caller)
}
