...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.ChangePasswordRequest
	...
	resp, err := dal.ChangePassword(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully ChangePassword for entity: "+req.PrimaryEmail+" for caller: "+caller)
}
