...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.LogoutRefreshTokenRequest
	...
	resp, err := dal.LogoutRefreshToken(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully LogoutRefreshToken for entity: "+req.Entity.String()+" for caller: "+caller)
}
