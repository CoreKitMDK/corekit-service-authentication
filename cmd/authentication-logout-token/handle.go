...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.LogoutTokenRequest
	...
	resp, err := dal.LogoutToken(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully LogoutToken for entity: "+req.Entity.String()+" for caller: "+caller)
}
