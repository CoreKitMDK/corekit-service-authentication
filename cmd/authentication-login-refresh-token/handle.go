...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.LoginRefreshTokenRequest
	...
	resp, err := dal.LoginRefreshToken(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully LoginRefreshToken for entity: "+req.Entity.String()+" for caller: "+caller)
}
