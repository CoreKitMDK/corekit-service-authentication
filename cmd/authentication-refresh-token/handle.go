...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := dal.RefreshToken(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully RefreshTokenRequest for entity: "+req.Entity.String()+" for caller: "+caller)
}
