...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.GetVerificationCodeRequest
	...
	resp, err := dal.GetVerificationCode(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully GetVerificationCode for entity: "+req.Entity.String()+" for caller: "+caller)
}
