...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	var req authentication.LogoutAllRequest
	...
	resp, err := dal.LogoutAll(context.Background(), &req)
	if err != nil {
	...
	Core.Logger.Log(logger.DEBUG, "Successfully LogoutAll for entity: "+req.Entity.String()+" for caller: "+caller)
}
